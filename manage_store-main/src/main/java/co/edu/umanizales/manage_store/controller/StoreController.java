...
@GetMapping (path = "/ventasXlacantidad/{cant}")
    public ResponseEntity<ResponseDTO> ventasXlacantidad(@PathVariable int cant){
        return new ResponseEntity<>(new ResponseDTO(200,storeService.ventasXlacantidad(1), null),HttpStatus.OK);
}
